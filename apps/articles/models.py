...
class ArticleInfo(models.Model):
	...
	image = models.ImageField(upload_to='article/%y/%m/%d', verbose_name='封面', max_length=200,default='article/default'+str(random.choice('1234567'))+'.jpg', null=True, blank=True)
	...
	taginfo = models.ForeignKey(TagInfo, verbose_name='所属标签',null=True,blank=True,on_delete=models.CASCADE)
...
class CommentInfo(models.Model):
	# 谁对谁什么时间操作了什么
	comment_man = models.ForeignKey(UserProfile, verbose_name='评论者',on_delete=models.CASCADE)
